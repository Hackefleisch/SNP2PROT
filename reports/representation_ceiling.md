...
At the configured width the floor is **0.9167**. The grid's mean AUPR per
regime is P1 0.026, P2 0.735, P3 0.864, S1 0.701, S2 0.275.
...
actually live it is unambiguous — S2 at 0.275, P1 at 0.026 against a floor of 0.9167. Those failures are not the shared space
...
Produced from `16f9c35` (tree dirty).
